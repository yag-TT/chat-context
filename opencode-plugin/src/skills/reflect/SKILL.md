...
- improve their opencode-multi-agent setup based on actual usage using opencode-multi-agent skill;
...
```json
{
  ...
  "project": "/home/user/Projects/opencode-multi-agent",
...
Store session summaries in `~/.config/opencode/opencode-multi-agent/reflections/sessions/`.
...
- active opencode-multi-agent preset, model routing, skills, and MCP permissions;
